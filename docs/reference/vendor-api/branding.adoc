...
|**Body**|**Body** +
__optional__|Branding create parameters|<<_createbranding_body,Body>>
|===
...
|**channel_id** +
__required__|ChannelID to create branding for|string
|**css** +
__required__|CSS to apply to the channel|string
|===
...
__required__|App identifier|string
|**Query**|**channelID** +
__required__|ID of the channel to remove branding from.|string
|===
