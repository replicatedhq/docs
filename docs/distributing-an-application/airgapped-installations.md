...
it is important that your customer set the `--trust-server-names` flag for `wget` or rename to the file to
...
renaming them to with the .airgap extension and placing them in the locations specified on the /console/settings
page.
